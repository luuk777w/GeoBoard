                        ...
                        <div className="panel-right">
                            ...
                            <form method="post" id="forgotPasswordForm" onSubmit={(event) => this.onSubmit(event)}>
                                ...
                                <div className="submit-button-container">
                                    <Button isLoading={this.state.isSubmitting} type="submit" className="button submit-button">Request password reset</Button>
                                    <Link to="/login" className="button button-link button-pd-2 mt-2"><i className="fas fa-arrow-left fw-fw mr-1"></i>Back to login</Link>
                                </div>
                            </form>
                        </div>
                    </div>
